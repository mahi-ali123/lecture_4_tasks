...
export const SignupPage = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // In a real app we might ask them to verify email, but assuming auto-confirm for ease
      navigate("/dashboard");
    }
  };
    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="w-full max-w-md p-8 rounded-3xl bg-card border border-border shadow-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-2">Start analyzing thumbnails today.</p>
        </div>
